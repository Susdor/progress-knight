...
const skillBaseData = {
    ...
    "Divine efficiency": {name: "Divine efficiency", maxXp: 100, effect: 0.002, description: "Class Pay"},
...
const skillCategories = {
    ...
    "Light Magic"            : ["Pure Mind", "Holy Heart", "Good Virtue", "Light Training", "Light Meditation", "Divine efficiency", "Determination", "Light Aura", "Parallel Realm", "Holy Incarnate"],
...
const tooltips = {
    ...
    "Divine efficiency": "Do better at your job to get promoted and get better pay",
...
function addMultipliers() {
    for (taskName in gameData.taskData) {
        ...
        if (task instanceof Job) {
            ...
            task.incomeMultipliers.push(getBindedTaskEffect("Divine efficiency"))
...
function pathway() {
    ...
    "Lieutenant General": new TaskRequirement([getTaskElement("Lieutenant General")], [{task: "Mana Control", requirement: 1000}, {task: "Battle Tactics", requirement: 1000}, {task: "Holy Knight", requirement: 10}]),
        ...
        "Divine efficiency": new GoodRequirement([getTaskElement("Divine efficiency")], [{requirement: 500}]),
	    ...
	    "Celestial Realm": new CoinRequirement([getItemElement("Celestial Realm")], [{requirement: itemBaseData["Celestial Realm"].expense * 1000000}]),
	    "Void Universe": new CoinRequirement([getItemElement("Void Universe")], [{requirement: itemBaseData["Void Universe"].expense * 100}]),
	    "Celestial Universe": new CoinRequirement([getItemElement("Celestial Universe")], [{requirement: itemBaseData["Celestial Universe"].expense * 1000000}]),
	    ...
	    "Astral Necklace": new CoinRequirement([getItemElement("Astral Necklace")], [{requirement: itemBaseData["Astral Necklace"].expense * 1000000}]),
	    "Astral Armor": new CoinRequirement([getItemElement("Astral Armor")], [{requirement: itemBaseData["Astral Armor"].expense * 1000000}]),
	    "Celestial Sword": new CoinRequirement([getItemElement("Celestial Sword")], [{requirement: itemBaseData["Celestial Sword"].expense * 1000000}]),
	    "Celestial Orb": new CoinRequirement([getItemElement("Celestial Orb")], [{requirement: itemBaseData["Celestial Orb"].expense * 1000000}]),
	    "Astral Dust": new CoinRequirement([getItemElement("Astral Dust")], [{requirement: itemBaseData["Astral Dust"].expense * 1000000}]),
    ...
    "Lieutenant General": new TaskRequirement([getTaskElement("Lieutenant General")], [{task: "Mana Control", requirement: 1000}, {task: "Battle Tactics", requirement: 1000}, {task: "Holy Knight", requirement: 10}]),
	    ...
	    "Cosmic Longevity": new TaskRequirement([getTaskElement("Cosmic Longevity")], [{task: "Eternal Wanderer", requirement: 1}]),
        "Cosmic Recollection": new TaskRequirement([getTaskElement("Cosmic Recollection")], [{task: "Nova", requirement: 50}, {task: "Meditation", requirement: 4200}]),
	    "Essence Collector": new TaskRequirement([getTaskElement("Essence Collector")], [{task: "Sigma Proioxis", requirement: 500}, {task: "Pure Wish", requirement: 4900}, {task: "Divine efficiency", requirement: 6300}]),
	    "Galactic Command": new TaskRequirement([getTaskElement("Galactic Command")], [{task: "Essence Collector", requirement: 5000}, {task: "Bargaining", requirement: 5000}]),
	    ...
	    "Nation Ruler": new CoinRequirement([getItemElement("Nation Ruler")], [{requirement: itemBaseData["Nation Ruler"].expense * 100}]),
        "Pocket Dimension": new CoinRequirement([getItemElement("Pocket Dimension")], [{requirement: itemBaseData["Pocket Dimension"].expense * 100}]),
	    "Void Realm": new CoinRequirement([getItemElement("Void Realm")], [{requirement: itemBaseData["Void Realm"].expense * 1000000}]),
	    "Celestial Realm": new CoinRequirement([getItemElement("Celestial Realm")], [{requirement: itemBaseData["Celestial Realm"].expense * 100}]),
	    "Void Universe": new CoinRequirement([getItemElement("Void Universe")], [{requirement: itemBaseData["Void Universe"].expense * 1000000}]),
	    ...
	    "Observatory": new CoinRequirement([getItemElement("Observatory")], [{requirement: itemBaseData["Observatory"].expense * 100}]),
	    "Mind's Eye": new CoinRequirement([getItemElement("Mind's Eye")], [{requirement: itemBaseData["Mind's Eye"].expense * 100}]),
	    "Void Necklace": new CoinRequirement([getItemElement("Void Necklace")], [{requirement: itemBaseData["Void Necklace"].expense * 1000000}]),
	    "Void Armor": new CoinRequirement([getItemElement("Void Armor")], [{requirement: itemBaseData["Void Armor"].expense * 1000000}]),
	    "Void Blade": new CoinRequirement([getItemElement("Void Blade")], [{requirement: itemBaseData["Void Blade"].expense * 1000000}]),
	    "Void Orb": new CoinRequirement([getItemElement("Void Orb")], [{requirement: itemBaseData["Void Orb"].expense * 1000000}]),
	    "Void Dust": new CoinRequirement([getItemElement("Void Dust")], [{requirement: itemBaseData["Void Dust"].expense * 1000000}]),
