...
class GameRequirement extends Requirement {
    constructor(elements, requirements) {
        super(elements, requirements)
        this.type = "game"
    }
    ...
    getCondition(requirement) {
        return gameData.game >= requirement.requirement
    }    
}

class GoodRequirement extends Requirement {
    constructor(elements, requirements) {
        super(elements, requirements)
        this.type = "good"
    }
    ...
    getCondition(requirement) {
        return gameData.good >= requirement.requirement
    }    
}